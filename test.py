...
parser = argparse.ArgumentParser(description='WavTrans')

# model name
parser.add_argument('--experiment_name', type=str, default='train_knee_wv_4x', help='give a experiment name before training')
parser.add_argument('--model_type', type=str, default='WavTrans', help='model type')
...
parser.add_argument('--mask_path', type=str, default='/mask/lr_4x.mat', help='data list_dir root folder')
parser.add_argument('--dataset', type=str, default='Cartesian', help='dataset name')

# model architectures
parser.add_argument('--net_G', type=str, default='WV', help='generator network')
parser.add_argument('--n_recurrent', type=int, default=1, help='Number of reccurent block in model')
parser.add_argument('--use_prior', default=False, action='store_true', help='use prior')
...
sio.savemat(os.path.join(image_directory, 'test_eval.mat'), model.results)
